...
if (get_option('oa_social_login_api_settings_verified') !== '1')
    ...
    ?>
					...
					<ul>
                        ...
                        <li class="oa_social_login_shortcodes"><?php printf(__('You want to display the icons in another place ? Take a look at <a target="_blank" href="%s">Shortcodes</a>', 'oa-social-login'), 'http://docs.oneall.com/plugins/guide/social-login-wordpress/#4');?>.</li>
					</ul>
				</div>
					<?php
